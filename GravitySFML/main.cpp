...
int main()
{
	...
	sf::RenderWindow* window = new sf::RenderWindow(sf::VideoMode(2400, 1300), "Gravity", sf::Style::Default, settings);
	...
	planets[4] = Planet(2, sf::Color(127, 127, 127), sf::Vector2f(850, 630), sf::Vector2f(0.00, -0.30), 0.01);
